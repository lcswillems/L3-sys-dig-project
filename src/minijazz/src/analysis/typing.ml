...
module Modules = struct
  ...
  let _ =
    ...
    add_sig ~params:["n"] "and_n" [TBitArray (mk_static_var "n");TBitArray (mk_static_var "n")] [TBitArray (mk_static_var "n")];
    add_sig ~params:["n"] "xor_n" [TBitArray (mk_static_var "n");TBitArray (mk_static_var "n")] [TBitArray (mk_static_var "n")];
    add_sig ~params:["n"] "or_n" [TBitArray (mk_static_var "n");TBitArray (mk_static_var "n")] [TBitArray (mk_static_var "n")];
    add_sig ~params:["n"] "mux_n" [TBit;TBitArray (mk_static_var "n");TBitArray (mk_static_var "n")] [TBitArray (mk_static_var "n")];
    add_sig ~params:["n"] "reg_n" [TBitArray (mk_static_var "n")] [TBitArray (mk_static_var "n")];
